...
- Teleost species of North Western Mediterranean are classified in `r length(unique(na.omit(louisy$family)))` families, `r length(unique(na.omit(louisy$genus)))` genera, and `r length(unique(na.omit(louisy$species)))` species. 

- Among which, coastal species represent `r length(unique(na.omit(l$family)))` families, `r length(unique(na.omit(l$genus)))` genera, and `r length(unique(na.omit(l$species)))` species.
