...
```{r}
## Quantile regression for high catches, medium catches and low catches with discrete variable : factor region, then factor topography

# Regression per species according to region
...
Try to find some criterion to cut off dendrogramm
