...
list_scarce <- right_join(d, scarce_species)
...
list_cosmo <- right_join(d, cosmo_species)
...
dd_test$substrate <- NA

#Give a substrate to each site

dd_test$substrate[which(dd_test$site=="Port Vendres")]<-"sand"
dd_test$substrate[which(dd_test$site=="Leucate")]<-"sand"
dd_test$substrate[which(dd_test$site=="Agde")]<-"sand"
dd_test$substrate[which(dd_test$site=="Carry")]<-"rocky"
dd_test$substrate[which(dd_test$site=="Marseille")]<-"rocky"
dd_test$substrate[which(dd_test$site=="Cassis")]<-"rocky"
dd_test$substrate[which(dd_test$site=="La Ciotat")]<-"rocky"
dd_test$substrate[which(dd_test$site=="Les Embiez")]<-"rocky"
dd_test$substrate[which(dd_test$site=="Port-Cros")]<-"rocky"
dd_test$substrate[which(dd_test$site=="Villefranche")]<-"rocky"
dd_test$substrate[which(dd_test$site=="Bastia")]<-"rocky"
dd_test$substrate[which(dd_test$site=="Saint Florent")]<-"rocky"
dd_test$substrate[which(dd_test$site=="Bonifacio")]<-"rocky"


#Plot
dd_subs <- dd_test %>% group_by(substrate, species) %>% summarise(mean = mean(cpue))

ggplot(dd_subs, aes(x = species, y = mean))+geom_bar(stat='identity') + facet_grid(~substrate) +theme(axis.text.x=element_text(angle=25, hjust=1))


#Test differences between site and substrate
wilcox.test(cpue~substrate, data=dd_test)
