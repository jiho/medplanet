...
summary_effort
dd$site <- factor(dd$site, levels=levels(dd$site), labels=str_c(levels(dd$site), " (n=", summary_effort$n_CARE_fished, ")"))

ggplot(dd) +
  geom_boxplot(aes(x=site, y=cpue), na.rm=T) +
  geom_quantiled(mapping=aes(x=dd$site, y=dd$cpue), quantiles=0.9, colour="black", size=3, shape=0) +
  scale_x_discrete(limits=rev(levels(dd$site))) +
