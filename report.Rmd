...
ggplot(dd, aes(x=fake_date, y=cpue)) + geom_point(size=1, alpha=0.5) + geom_smooth(size=0.5, color="#F55D5B", fill="#F55D5B", method="gam") + scale_x_date("month", date_breaks="1 month", date_labels="%b")
```
